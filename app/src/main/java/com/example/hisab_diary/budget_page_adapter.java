...
public class budget_page_adapter extends RecyclerView.Adapter<budget_page_adapter.MyviewHolder>{
    ...
    budget_page_adapter(Activity activity,
                     Context context,
                     ArrayList id,
                     ArrayList amount,
                     ArrayList tag){
    ...
    public MyviewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View view = inflater.inflate(R.layout.main_page_budget_row,parent,false);
    ...
    @Override
    public void onBindViewHolder(@NonNull final budget_page_adapter.MyviewHolder holder, final int position)  {
      ...
      //  holder.amount.setText(String.valueOf(amount.get(position)));
        ...
        holder.layout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(context, Cate_wise_budget.class);
    ...
    LinearLayout layout;
       ...
       //     amount = itemView.findViewById(R.id.amonut_1);
            tag = itemView.findViewById(R.id.tag_id_1);
            imageView = itemView.findViewById(R.id.image_view_1_id);
            progressBar = itemView.findViewById(R.id.progress_id_1);
            text = itemView.findViewById(R.id.text_id_1);
            layout = itemView.findViewById(R.id.row_id_1);
