...
public class Year_Analysis extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        customeAdapter = new customeAdapter(Year_Analysis.this,this,id,amounts,transaction_type,tag,date,note,created_at,payment);
